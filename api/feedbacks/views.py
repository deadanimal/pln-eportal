...
class FeedbackViewSet(NestedViewSetMixin, viewsets.ModelViewSet):
    ...
    def get_audit_log(self, request, *args, **kwargs):
        queryset1 = Feedback.history.all().values('history_id', 'history_date', 'history_change_reason', 'history_type', 'history_user__full_name')
        for qs in queryset1:
            qs['history_model_name'] = 'Maklum Balas'
