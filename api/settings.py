...
ALLOWED_HOSTS = [
    'api.planetariumnegara.gov.my',
    '127.0.0.1',
    'localhost',
    'http://localhost:4200',
    'https://planetarium-pos.prototype.com.my'
]
...
CORS_ORIGIN_WHITELIST = [
    ...
    'http://admin.planetariumnegara.gov.my',
    'http://127.0.0.1',
    'http://localhost',
    'http://localhost:4200',
    'https://planetarium-pos.prototype.com.my'
...
CRONJOBS = [
    ...
    ('*/5 * * * *', 'showings.cron.auto_change_status', '>> '+os.path.join(BASE_DIR,'log/cron.log')),
]
