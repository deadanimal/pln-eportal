...
export class CloseBookingComponent implements OnInit {
  ...
  modules = [
    ...
    {
      value: "facility_TA",
      display_name: "Fasiliti (Teater Angkasa)",
    },
    {
      value: "facility_GP",
      display_name: "Fasiliti (Galeri Pameran)",
    },
    {
      value: "facility_TT",
      display_name: "Fasiliti (Bilik Orion)",
    },
    {
      value: "facility_BC",
      display_name: "Fasiliti (Bilik Centaurus)",
    },
    {
      value: "facility_KR",
      display_name: "Fasiliti (Kawasan Rekreasi)",
    },
    {
      value: "facility_SM",
      display_name: "Fasiliti (Stesen Mikrosatelit)",
    },
    {
      value: "program",
