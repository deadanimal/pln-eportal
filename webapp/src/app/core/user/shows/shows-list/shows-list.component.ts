...
export class ShowsListComponent implements OnInit {
  ...
  getData() {
    let fakeData = [
      { 'date': '20/05/2020', 'start_time': '10.00 am', 'end_time': '10.20a m', 'title': 'Dynamic Earth', 'status': 'active', 'description': 'The award-winning Dynamic Earth explor...' },
      { 'date': '20/05/2020', 'start_time': '12.00 pm', 'end_time': '12.20 pm', 'title': 'The Little Prince', 'status': 'active', 'description': 'A timeless classic... The Little Prince is bac...' },
      { 'date': '20/05/2020', 'start_time': '2.00 pm', 'end_time': '2.20 pm', 'title': 'Shedding Light on The Universe', 'status': 'active', 'description': 'The Planetarium show entitle...'},
      { 'date': '20/05/2020', 'start_time': '4.00 pm', 'end_time': '4.20 pm', 'title': 'Limpahan Chaaya di Alam Semesta', 'status': 'active', 'description': 'Tayangan Planetarium....' }
    ]
