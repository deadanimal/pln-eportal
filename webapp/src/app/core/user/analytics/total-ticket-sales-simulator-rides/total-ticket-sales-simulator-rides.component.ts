...
@Component({
  selector: 'app-total-ticket-sales-simulator-rides',
  templateUrl: './total-ticket-sales-simulator-rides.component.html',
  styleUrls: ['./total-ticket-sales-simulator-rides.component.scss']
})
export class TotalTicketSalesSimulatorRidesComponent implements OnInit {
  // Chart
