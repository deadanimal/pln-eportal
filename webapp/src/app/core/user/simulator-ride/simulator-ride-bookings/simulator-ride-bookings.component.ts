...
@Component({
  selector: "app-simulator-ride-bookings",
  templateUrl: "./simulator-ride-bookings.component.html",
  styleUrls: ["./simulator-ride-bookings.component.scss"],
})
export class SimulatorRideBookingsComponent implements OnInit {
  // Data
          ...
          .subscribe(
            ...
            () => {
              this.toastr
                ...
                .subscribe(() => {
                  this.router
                    .navigate(["/simulator-ride/applications"])
                    .then(() => {
