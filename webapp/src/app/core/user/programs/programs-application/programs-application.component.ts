...
export class ProgramsApplicationComponent implements OnInit {
      ...
      .then((result) => {
        if (result.isConfirmed == true) {
          ...
          let notificationBody = {
            'title': 'Pengesahan Program Pendidikan',
            'description': 'Program pendidikan anda telah disahkan',
            'user': row.customer_id.id,
          }
          ...
          let notificationBody = {
            'title': 'Pengesahan Program Pendidikan',
            'description': 'Program pendidikan anda telah ditolak',
            'user': row.customer_id.id,
          }
    ...
    swal
      ...
      .then((result) => {
        if (result.isConfirmed == true) {
          ...
          let notificationBody = {
            'title': 'Pengesahan Penyertaan (NSC & Rocket)',
            'description': 'Penyertaan anda telah disahkan',
            'user': row.customer_id.id,
          }
          ...
          let notificationBody = {
            'title': 'Pengesahan Penyertaan (NSC & Rocket)',
            'description': 'Penyertaan anda telah ditolak',
            'user': row.customer_id.id,
          }
  ...
  sendmail(row) {
    let user = this.users.filter((obj) => {
      return obj.id == row.customer_id.id;
    });
    // AP : "Diterima"
    // IP : "Dalam proses"
    // RJ : "Ditolak"
